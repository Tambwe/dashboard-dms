...
<div class="py-4">
    <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="mb-4 flex items-center justify-between">
            <h2 class="text-2xl font-semibold text-gray-900 dark:text-white">Nouveau choix OSSAT</h2>
        ...
        <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
            <form method="POST" action="{{ route('admin.ossat-choix.store') }}">
                @csrf
                @include('admin.ossat-choix._form', ['ossatChoix' => null])
