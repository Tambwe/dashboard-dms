...
@section('subtitle', 'Mise à jour des informations de ' . $user->name)
    ...
    <div class="card p-6">
        <form action="{{ route('admin.users.update', $user) }}" method="POST" class="space-y-6">
            ...
            <div class="border-t border-gray-200 dark:border-gray-700 pt-6">
                <h4 class="text-sm font-medium text-gray-900 dark:text-white mb-4">Changer le mot de passe (optionnel)</h4>
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="password" name="password" id="password"
                            class="mt-1 block w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:border-primary-500 focus:ring-primary-500">
                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Minimum 8 caractères. Laissez vide pour conserver l'actuel.</p>
                        @error('password')
                            <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                        @enderror
                    </div>
