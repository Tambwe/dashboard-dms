...
<div class="py-6">
    <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
        <div class="mb-6 flex items-center gap-3">
            ...
            <div>
                <h2 class="text-2xl font-bold text-gray-900 dark:text-white">Modifier l'indicateur</h2>
                <p class="mt-1 text-sm text-gray-600 dark:text-gray-400 font-mono">{{ $indicator->code }}</p>
            </div>
        </div>

        <div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg overflow-hidden">
            <form action="{{ route('admin.programme.indicateurs.update', $indicator) }}" method="POST" class="p-6 space-y-6">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="reference" id="reference" value="{{ old('reference', $indicator->reference) }}"
                    ...
                    <div>
                        ...
                        <input type="text" name="code" id="code" value="{{ old('code', $indicator->code) }}"
                ...
                <div>
                    ...
                    <input type="text" name="label" id="label" value="{{ old('label', $indicator->label) }}"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="unit" id="unit" value="{{ old('unit', $indicator->unit) }}"
                    ...
                    <div>
                        ...
                        <input type="text" name="frequency" id="frequency" value="{{ old('frequency', $indicator->frequency) }}"
                               class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg dark:bg-gray-700 dark:text-white">
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="owner" id="owner" value="{{ old('owner', $indicator->owner) }}"
                               class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg dark:bg-gray-700 dark:text-white">
                    </div>
                    <div>
                        ...
                        <input type="text" name="verification_source" id="verification_source" value="{{ old('verification_source', $indicator->verification_source) }}"
                               class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg dark:bg-gray-700 dark:text-white">
                    </div>
                </div>
