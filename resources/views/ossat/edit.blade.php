...
<div class="container mx-auto px-4 py-6 max-w-7xl">
    <div class="mb-6 flex items-center justify-between">
        <div>
            <h1 class="text-3xl font-bold text-gray-800">Modifier le Rapport OSSAT</h1>
            <p class="text-gray-500 mt-1">{{ $ossat->site_nom }} – {{ $ossat->province->name ?? '' }}</p>
        </div>
        <a href="{{ route('ossat.show', $ossat) }}" class="text-blue-600 hover:text-blue-800 flex items-center gap-2">
    ...
    <form method="POST" action="{{ route('ossat.update', $ossat) }}" id="ossatForm" novalidate>
        @csrf
        @method('PUT')
            ...
            <div class="bg-white rounded-lg shadow p-6 mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="enumerator_name" value="{{ old('enumerator_name', $ossat->enumerator_name) }}" required
                            class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Téléphone</label>
                        <input type="text" name="phonenumber" value="{{ old('phonenumber', $ossat->phonenumber) }}"
                            class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                    </div>
                    <div>
                        ...
                        <select name="fait_partie_agence" class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                            <option value="">--</option>
                            <option value="1" {{ old('fait_partie_agence', $ossat->fait_partie_agence) == '1' ? 'selected' : '' }}>Oui</option>
                            <option value="0" {{ old('fait_partie_agence', $ossat->fait_partie_agence) == '0' && $ossat->fait_partie_agence !== null ? 'selected' : '' }}>Non</option>
                        </select>
                    </div>
                    <div id="cond_agence_enqueteur">
                        <label class="block text-sm font-medium text-gray-700 mb-1">Organisation / Agence</label>
                        <input type="text" name="agence_enqueteur" value="{{ old('agence_enqueteur', $ossat->agence_enqueteur) }}"
                            class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Date de collecte</label>
                        <input type="date" name="today" value="{{ old('today', $ossat->today?->format('Y-m-d')) }}"
                            class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Données pour un nouveau site ?</label>
                        <select name="nouveau_site" class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                            <option value="">--</option>
                            <option value="1" {{ old('nouveau_site', $ossat->nouveau_site) == '1' ? 'selected' : '' }}>Oui – nouveau site</option>
                            <option value="0" {{ old('nouveau_site', $ossat->nouveau_site) == '0' && $ossat->nouveau_site !== null ? 'selected' : '' }}>Non – site existant</option>
                        </select>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow p-6 mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <select name="province_id" required id="province_id"
                            ...
                            @foreach($provinces as $p)
                                <option value="{{ $p->id }}" {{ old('province_id', $ossat->province_id) == $p->id ? 'selected' : '' }}>{{ $p->name }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div>
                        ...
                        <select name="territoire_id" required id="territoire_id"
                            ...
                            @foreach($territoires as $t)
                                <option value="{{ $t->id }}" data-province="{{ $t->province_id }}"
                                    {{ old('territoire_id', $ossat->territoire_id) == $t->id ? 'selected' : '' }}>{{ $t->name }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="md:col-span-2">
                        ...
                        <input type="hidden" name="site_nom" id="site_nom_hidden" value="{{ old('site_nom', $ossat->site_nom) }}">
                        <input type="hidden" name="site_code" id="site_code_hidden" value="{{ old('site_code', $ossat->site_code) }}">
                    </div>
                    <div>
                        ...
                        <select name="type_installation" required
                            ...
                            @foreach($choices['type_installation'] as $opt)
                                <option value="{{ $opt }}" {{ old('type_installation', $ossat->type_installation) == $opt ? 'selected' : '' }}>{{ $opt }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div>
                        ...
                        <select name="propriete_fonciere"
                            ...
                            @foreach($choices['propriete'] as $opt)
                                <option value="{{ $opt }}" {{ old('propriete_fonciere', $ossat->propriete_fonciere) == $opt ? 'selected' : '' }}>{{ $opt }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div>
                        ...
                        <select name="statut" required
                            class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                            <option value="">Sélectionner</option>
                            <option value="fonctionnel" {{ old('statut', $ossat->statut) == 'fonctionnel' ? 'selected' : '' }}>Fonctionnel</option>
                            <option value="non_fonctionnel" {{ old('statut', $ossat->statut) == 'non_fonctionnel' ? 'selected' : '' }}>Non fonctionnel</option>
                            <option value="en_attente" {{ old('statut', $ossat->statut) == 'en_attente' ? 'selected' : '' }}>En attente</option>
                        </select>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow p-6 mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div>
                        ...
                        <input type="number" step="0.0000001" name="gps_latitude" value="{{ old('gps_latitude', $ossat->gps_latitude) }}"
                            class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Longitude</label>
                        <input type="number" step="0.0000001" name="gps_longitude" value="{{ old('gps_longitude', $ossat->gps_longitude) }}"
                            class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Altitude (m)</label>
                        <input type="number" step="0.01" name="gps_altitude" value="{{ old('gps_altitude', $ossat->gps_altitude) }}"
                            class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Mois et année de mise à jour</label>
                        <input type="date" name="date_mise_a_jour" value="{{ old('date_mise_a_jour', $ossat->date_mise_a_jour?->format('Y-m-d')) }}"
                            class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                    </div>
                </div>
                <div class="mt-4">
        ...
        <div class="tab-section hidden" id="tab-s4">
            <div class="bg-white rounded-lg shadow p-6 mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <x-ossat-yesno name="agence_gestion" label="5.2. Existe-t-il une organisation de gestion du site ?" value="{{ $ossat->agence_gestion }}" />
                    <div id="cond_agence_gestion_nom">
                        <label class="block text-sm font-medium text-gray-700 mb-1">5.3. Nom de l'organisation</label>
                        <input type="text" name="agence_gestion_nom" value="{{ old('agence_gestion_nom', $ossat->agence_gestion_nom) }}"
                            class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                    </div>
                    <x-ossat-yesno name="gestionnaire_dedie" label="5.4. Le site a-t-il un gestionnaire dédié ?" value="{{ $ossat->gestionnaire_dedie }}" />
                    <div id="cond_gestionnaire_details" class="col-span-full grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" name="gestionnaire_nom" value="{{ old('gestionnaire_nom', $ossat->gestionnaire_nom) }}"
                                class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                        </div>
                        <div>
                            ...
                            <select name="gestionnaire_sexe"
                                ...
                                @foreach($choices['sexe'] as $opt)
                                    <option value="{{ $opt }}" {{ old('gestionnaire_sexe', $ossat->gestionnaire_sexe) == $opt ? 'selected' : '' }}>{{ $opt }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">5.7. Téléphone gestionnaire</label>
                            <input type="text" name="gestionnaire_telephone" value="{{ old('gestionnaire_telephone', $ossat->gestionnaire_telephone) }}"
                                class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">5.8. Email gestionnaire</label>
                            <input type="email" name="gestionnaire_email" value="{{ old('gestionnaire_email', $ossat->gestionnaire_email) }}"
                                class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                        </div>
                        <x-ossat-yesno name="gestionnaire_accepte_partage" label="5.9. Le gestionnaire accepte-t-il le partage de ses coordonnées ?" value="{{ $ossat->gestionnaire_accepte_partage }}" />
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="tab-section hidden" id="tab-s5">
            <div class="bg-white rounded-lg shadow p-6 mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <x-ossat-yesno name="agence_admin" label="6.1. Existe-t-il une agence administrative ?" value="{{ $ossat->agence_admin }}" />
                    <div id="cond_agence_admin_nom">
                        ...
                        <input type="text" name="agence_admin_nom" value="{{ old('agence_admin_nom', $ossat->agence_admin_nom) }}"
                            class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                    </div>
                    <x-ossat-yesno name="admin_dedie" label="5.2. Le site a-t-il un administrateur dédié ?" value="{{ $ossat->admin_dedie }}" />
                    <div id="cond_admin_details" class="col-span-full grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" name="admin_nom" value="{{ old('admin_nom', $ossat->admin_nom) }}"
                                class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                        </div>
                        <div>
                            ...
                            <select name="admin_sexe"
                                ...
                                <option value="">--</option>
                                @foreach($choices['sexe'] as $opt)
                                    <option value="{{ $opt }}" {{ old('admin_sexe', $ossat->admin_sexe) == $opt ? 'selected' : '' }}>{{ $opt }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Téléphone administrateur</label>
                            <input type="text" name="admin_telephone" value="{{ old('admin_telephone', $ossat->admin_telephone) }}"
                                class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                        </div>
                    </div>
                    <x-ossat-yesno name="agence_coord" label="6.1. Existe-t-il une agence de coordination ?" value="{{ $ossat->agence_coord }}" />
                    <div id="cond_agence_coord_nom">
                        ...
                        <input type="text" name="agence_coord_nom" value="{{ old('agence_coord_nom', $ossat->agence_coord_nom) }}"
                            class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                    </div>
                </div>
            </div>
        ...
        <div class="tab-section hidden" id="tab-s6">
            <div class="bg-white rounded-lg shadow p-6 mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <x-ossat-yesno name="bureau_dedie" label="7.1. Existe-t-il un bureau dédié à la gestion du site ?" value="{{ $ossat->bureau_dedie }}" />
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">7.2. Nombre d'hommes dans l'équipe</label>
                        <input type="number" name="nb_hommes_staff" value="{{ old('nb_hommes_staff', $ossat->nb_hommes_staff ?? 0) }}" min="0"
                            class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">7.3. Nombre de femmes dans l'équipe</label>
                        <input type="number" name="nb_femmes_staff" value="{{ old('nb_femmes_staff', $ossat->nb_femmes_staff ?? 0) }}" min="0"
                            class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                    </div>
                    <x-ossat-yesno name="presence_comite" label="7.4. Y a-t-il des comités présents sur le site ?" value="{{ $ossat->presence_comite }}" />
                </div>
                <div id="cond_comites_details" class="mt-4">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-3 gap-2">
                        ...
                        @php $comites = old('comites', (array)($ossat->comites ?? [])); @endphp
                        <label class="flex items-center gap-2 text-sm">
                            <input type="checkbox" name="comites[]" value="{{ $opt }}"
                                {{ in_array($opt, $comites) ? 'checked' : '' }}
                                class="h-4 w-4 text-blue-600 border-gray-300 rounded">
                            {{ $opt }}
                        </label>
                        @endforeach
                    </div>
                    <input type="text" name="autres_comites" value="{{ old('autres_comites', $ossat->autres_comites) }}" placeholder="Autres comités..."
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
                    <div id="cond_comites_election" class="col-span-full grid grid-cols-1 md:grid-cols-2 gap-6">
                        <x-ossat-yesno name="comites_elus" label="Les comités ont-ils été élus ?" value="{{ $ossat->comites_elus }}" />
                        <div>
                            ...
                            <select name="comites_fonctionnels"
                                class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                                <option value="">--</option>
                                <option value="Oui" {{ old('comites_fonctionnels', $ossat->comites_fonctionnels) == 'Oui' ? 'selected' : '' }}>Oui</option>
                                <option value="Non" {{ old('comites_fonctionnels', $ossat->comites_fonctionnels) == 'Non' ? 'selected' : '' }}>Non</option>
                                <option value="Partiellement" {{ old('comites_fonctionnels', $ossat->comites_fonctionnels) == 'Partiellement' ? 'selected' : '' }}>Partiellement</option>
                            </select>
                        </div>
                    </div>
                    <x-ossat-yesno name="reunions_coordination" label="7.8. Des réunions de coordination sont-elles organisées ?" value="{{ $ossat->reunions_coordination }}" />
                    <div id="cond_periodicite_reunions">
                        ...
                        <select name="periodicite_reunions"
                            ...
                            @foreach($choices['periodicite'] as $opt)
                                <option value="{{ $opt }}" {{ old('periodicite_reunions', $ossat->periodicite_reunions) == $opt ? 'selected' : '' }}>{{ $opt }}</option>
                            @endforeach
                        </select>
                    </div>
                    <x-ossat-yesno name="cci" label="7.6. Existe-t-il un centre communautaire d'information ?" value="{{ $ossat->cci }}" />
                    <x-ossat-yesno name="mgp" label="7.7. Existe-t-il un mécanisme fonctionnel de gestion de plaintes ?" value="{{ $ossat->mgp }}" />
                </div>
            </div>
        </div>
        ...
        <div class="tab-section hidden" id="tab-s7">
            <div class="bg-white rounded-lg shadow p-6 mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <x-ossat-yesno name="pdi_nouvelles_arrivees" label="8.1. Y a-t-il des PDI nouvellement arrivées ce mois ?" value="{{ $ossat->pdi_nouvelles_arrivees }}" />
                    <div id="cond_pdi_nouvelles_qtite">
                        ...
                        <input type="number" name="pdi_nouvelles_qtite" value="{{ old('pdi_nouvelles_qtite', $ossat->pdi_nouvelles_qtite ?? 0) }}" min="0"
                            class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                    </div>
                    <x-ossat-yesno name="pdi_retours" label="8.2. Y a-t-il des PDI retournées ce mois ?" value="{{ $ossat->pdi_retours }}" />
                    <div id="cond_pdi_retours_qtite">
                        <label class="block text-sm font-medium text-gray-700 mb-1">Nombre de retours</label>
                        <input type="number" name="pdi_retours_qtite" value="{{ old('pdi_retours_qtite', $ossat->pdi_retours_qtite ?? 0) }}" min="0"
                            class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                    </div>
                </div>
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                    <div>
                        ...
                        <input type="number" name="nb_familles" value="{{ old('nb_familles', $ossat->nb_familles ?? 0) }}" min="0"
                            class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Nombre d'individus</label>
                        <input type="number" name="nb_individus" value="{{ old('nb_individus', $ossat->nb_individus ?? 0) }}" min="0"
                            class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                    </div>
                </div>
                    ...
                    <table class="w-full text-sm border">
                        ...
                        <tbody>
                            ...
                            <tr class="border-t">
                                ...
                                <td class="px-3 py-2">
                                    <input type="number" name="h_{{ $k }}" value="{{ old('h_'.$k, $ossat->{'h_'.$k} ?? 0) }}" min="0"
                                        class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 text-center">
                                </td>
                                <td class="px-3 py-2">
                                    <input type="number" name="f_{{ $k }}" value="{{ old('f_'.$k, $ossat->{'f_'.$k} ?? 0) }}" min="0"
                                        class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 text-center">
                                </td>
                            </tr>
                            @endforeach
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    <div>
                        ...
                        <input type="number" name="{{ $field }}" value="{{ old($field, $ossat->$field ?? 0) }}" min="0"
                            class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                    </div>
                    @endforeach
                </div>
            ...
            <div class="bg-white rounded-lg shadow p-6 mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                    <div>
                        ...
                        <input type="number" name="capacite_accueil" value="{{ old('capacite_accueil', $ossat->capacite_accueil ?? 0) }}" min="0"
                            class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">10.3 Familles sur liste d'attente</label>
                        <input type="number" name="familles_attente" value="{{ old('familles_attente', $ossat->familles_attente ?? 0) }}" min="0"
                            class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                    </div>
                    <x-ossat-yesno name="reduction_prevue" label="10.4 Réduction du site prévue ?" value="{{ $ossat->reduction_prevue }}" />
                </div>

                {{-- Types d'abris --}}
                <h3 class="text-lg font-semibold text-gray-700 mb-3">11. Types d'abris présents</h3>
                @php $typesAbri = old('types_abri', (array)($ossat->types_abri ?? [])); @endphp
                <div class="grid grid-cols-2 md:grid-cols-4 gap-2 mb-4">
                    @foreach($choices['types_abri'] as $opt)
                    <label class="flex items-center gap-2 text-sm">
                        <input type="checkbox" name="types_abri[]" value="{{ $opt }}"
                            {{ in_array($opt, $typesAbri) ? 'checked' : '' }}
                            class="h-4 w-4 text-blue-600 border-gray-300 rounded">
                        {{ $opt }}
                    </label>
                    @endforeach
                    ...
                    <table class="w-full text-sm border">
                        ...
                        <tbody>
                            ...
                            <tr class="border-t">
                                ...
                                @php $fname = $prefix.'_'.$suffix; @endphp
                                <td class="px-1 py-1">
                                    <input type="number" name="{{ $fname }}" value="{{ old($fname, $ossat->$fname ?? 0) }}" min="0"
                            ...
                            <tr class="border-t">
                                ...
                                <td class="px-1 py-1">
                                    <input type="number" name="construites_nb" value="{{ old('construites_nb', $ossat->construites_nb ?? 0) }}" min="0"
                                        class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 text-center text-xs">
                                </td>
                                <td class="px-1 py-1"></td>
                                <td class="px-1 py-1">
                                    <input type="number" name="construites_maintenance" value="{{ old('construites_maintenance', $ossat->construites_maintenance ?? 0) }}" min="0"
                                        class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 text-center text-xs">
                                </td>
                                <td class="px-1 py-1"></td>
                            </tr>
                    ...
                    <div>
                        ...
                        <select name="{{ $field }}"
                            ...
                            @foreach($choices['etat_infra'] as $opt)
                                <option value="{{ $opt }}" {{ old($field, $ossat->$field) == $opt ? 'selected' : '' }}>{{ $opt }}</option>
                            @endforeach
                        </select>
                    </div>
                    @endforeach
                    <div>
                        ...
                        <select name="risque_inondation"
                            ...
                            @foreach($choices['risque_inondation'] as $opt)
                                <option value="{{ $opt }}" {{ old('risque_inondation', $ossat->risque_inondation) == $opt ? 'selected' : '' }}>{{ $opt }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">14.5 Nombre d'incendies ce mois</label>
                        <input type="number" name="nb_incendies" value="{{ old('nb_incendies', $ossat->nb_incendies ?? 0) }}" min="0"
                            class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                    </div>
                    <x-ossat-yesno name="mesures_incendie" label="14.6 Mesures de prévention incendie ?" value="{{ $ossat->mesures_incendie }}" />
                </div>
                <div class="mt-4">
                    ...
                    <textarea name="autres_problemes" rows="3"
                        class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">{{ old('autres_problemes', $ossat->autres_problemes) }}</textarea>
                </div>

                {{-- Eclairage --}}
                <h3 class="text-lg font-semibold text-gray-700 mt-6 mb-3">15. Eclairage</h3>
                <x-ossat-yesno name="eclairage_existant" label="15.1 Existe-t-il de l'éclairage sur le site ?" value="{{ $ossat->eclairage_existant }}" />
                @php $sourcesElec = old('sources_electricite', (array)($ossat->sources_electricite ?? [])); @endphp
                <div id="cond_sources_electricite" class="mt-3">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-3 gap-2">
                        @foreach(['Groupe électrogène','Panneaux solaires','Réseau public','Batteries','Autre'] as $opt)
                        <label class="flex items-center gap-2 text-sm">
                            <input type="checkbox" name="sources_electricite[]" value="{{ $opt }}"
                                {{ in_array($opt, $sourcesElec) ? 'checked' : '' }}
                                class="h-4 w-4 text-blue-600 border-gray-300 rounded">
                            {{ $opt }}
                        </label>
                        @endforeach
            ...
            <div class="bg-white rounded-lg shadow p-6 mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="number" name="litres_eau_jour" value="{{ old('litres_eau_jour', $ossat->litres_eau_jour) }}" min="0"
                            class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">16.4 Jours sans accès eau (30 derniers jours)</label>
                        <input type="number" name="jours_sans_eau" value="{{ old('jours_sans_eau', $ossat->jours_sans_eau ?? 0) }}" min="0"
                            class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                    </div>
                    <x-ossat-yesno name="qualite_eau" label="16.3 Qualité de l'eau acceptable ?" value="{{ $ossat->qualite_eau }}" />
                    <x-ossat-yesno name="defecation_plein_air" label="16.5 Défécation à l'air libre ?" value="{{ $ossat->defecation_plein_air }}" />
                    <x-ossat-yesno name="savon_disponible" label="16.6 Savon disponible pour lavage mains ?" value="{{ $ossat->savon_disponible }}" />
                    <x-ossat-yesno name="inondations_6mois" label="16.7 Inondations dommageables (6 derniers mois) ?" value="{{ $ossat->inondations_6mois }}" />
                    <div>
                        ...
                        <select name="methode_elimination_dechets"
                            ...
                            @foreach($choices['elimination_dechets'] as $opt)
                                <option value="{{ $opt }}" {{ old('methode_elimination_dechets', $ossat->methode_elimination_dechets) == $opt ? 'selected' : '' }}>{{ $opt }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">16.10 Nombre de latrines fonctionnelles</label>
                        <input type="number" name="nb_latrines" value="{{ old('nb_latrines', $ossat->nb_latrines ?? 0) }}" min="0"
                            class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">16.12 Nombre de douches fonctionnelles</label>
                        <input type="number" name="nb_douches" value="{{ old('nb_douches', $ossat->nb_douches ?? 0) }}" min="0"
                            class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                    </div>
                    <x-ossat-yesno name="douches_separees" label="16.13 Douches séparées hommes/femmes ?" value="{{ $ossat->douches_separees }}" />
                    <x-ossat-yesno name="latrines_vidangees" label="16.14 Latrines vidangées ?" value="{{ $ossat->latrines_vidangees }}" />
                    <div id="cond_date_derniere_vidange">
                        <label class="block text-sm font-medium text-gray-700 mb-1">Date dernière vidange</label>
                        <input type="date" name="date_derniere_vidange" value="{{ old('date_derniere_vidange', $ossat->date_derniere_vidange?->format('Y-m-d')) }}"
                            class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                    </div>
                    <x-ossat-yesno name="eclairage_latrines" label="16.15 Eclairage autour des latrines/douches ?" value="{{ $ossat->eclairage_latrines }}" />
                    <x-ossat-yesno name="wash_adapte_handicapes" label="16.16 WASH adapté aux personnes handicapées ?" value="{{ $ossat->wash_adapte_handicapes }}" />
                </div>
                @php $sourcesEau = old('sources_eau', (array)($ossat->sources_eau ?? [])); @endphp
                <div class="mt-4">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-3 gap-2">
                        ...
                        <label class="flex items-center gap-2 text-sm">
                            <input type="checkbox" name="sources_eau[]" value="{{ $opt }}"
                                {{ in_array($opt, $sourcesEau) ? 'checked' : '' }}
                                class="h-4 w-4 text-blue-600 border-gray-300 rounded">
                            {{ $opt }}
                        </label>
                        @endforeach
                ...
                @php $typesLatrines = old('types_latrines', (array)($ossat->types_latrines ?? [])); @endphp
                <div class="mt-4">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-3 gap-2">
                        ...
                        <label class="flex items-center gap-2 text-sm">
                            <input type="checkbox" name="types_latrines[]" value="{{ $opt }}"
                                {{ in_array($opt, $typesLatrines) ? 'checked' : '' }}
                                class="h-4 w-4 text-blue-600 border-gray-300 rounded">
                            {{ $opt }}
                        </label>
                        @endforeach
        ...
        <div class="tab-section hidden" id="tab-s10">
            <div class="bg-white rounded-lg shadow p-6 mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <x-ossat-yesno name="soin_sante_fonctionnel" label="17.3 Prestataire de soins fonctionnel disponible ?" value="{{ $ossat->soin_sante_fonctionnel }}" />
                    <div id="cond_soin_sante_details" class="col-span-full grid grid-cols-1 md:grid-cols-2 gap-6">
                        <x-ossat-yesno name="soin_sante_interieur" label="17.4 Le prestataire est-il à l'intérieur du site ?" value="{{ $ossat->soin_sante_interieur }}" />
                        <div id="cond_distance_soin_sante">
                            <label class="block text-sm font-medium text-gray-700 mb-1">Distance du prestataire (km)</label>
                            <input type="text" name="distance_soin_sante" value="{{ old('distance_soin_sante', $ossat->distance_soin_sante) }}"
                                class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                        </div>
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Enfants &lt;5 ans non vaccinés (polio/rougeole)</label>
                        <input type="number" name="enfants_non_vaccines" value="{{ old('enfants_non_vaccines', $ossat->enfants_non_vaccines ?? 0) }}" min="0"
                            class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                    </div>
                    <x-ossat-yesno name="services_urgences" label="Services d'urgence ?" value="{{ $ossat->services_urgences }}" />
                    <x-ossat-yesno name="ambulance" label="Ambulance disponible ?" value="{{ $ossat->ambulance }}" />
                </div>
                @php $problemesSante = old('problemes_sante', (array)($ossat->problemes_sante ?? [])); @endphp
                <div class="mt-4">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-2">
                        ...
                        <label class="flex items-center gap-2 text-sm">
                            <input type="checkbox" name="problemes_sante[]" value="{{ $opt }}"
                                {{ in_array($opt, $problemesSante) ? 'checked' : '' }}
                                class="h-4 w-4 text-blue-600 border-gray-300 rounded">
                            {{ $opt }}
                        </label>
                        @endforeach
                    ...
                    <div>
                        ...
                        <select name="repas_par_jour"
                            ...
                            @foreach($choices['repas_par_jour'] as $opt)
                                <option value="{{ $opt }}" {{ old('repas_par_jour', $ossat->repas_par_jour) == $opt ? 'selected' : '' }}>{{ $opt }}</option>
                            @endforeach
                        </select>
                    </div>
                    <x-ossat-yesno name="stockage_magasin" label="19.3 Existence de magasins de stockage des vivres ?" value="{{ $ossat->stockage_magasin }}" />
                    <div>
                        ...
                        <select name="regularite_assistance_alimentaire"
                            ...
                            @foreach($choices['regularite_aide'] as $opt)
                                <option value="{{ $opt }}" {{ old('regularite_assistance_alimentaire', $ossat->regularite_assistance_alimentaire) == $opt ? 'selected' : '' }}>{{ $opt }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                @php $defisAlimentation = old('defis_alimentation', (array)($ossat->defis_alimentation ?? [])); @endphp
                <div class="mt-4">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-3 gap-2">
                        ...
                        <label class="flex items-center gap-2 text-sm">
                            <input type="checkbox" name="defis_alimentation[]" value="{{ $opt }}"
                                {{ in_array($opt, $defisAlimentation) ? 'checked' : '' }}
                                class="h-4 w-4 text-blue-600 border-gray-300 rounded">
                            {{ $opt }}
                        </label>
                        @endforeach
        ...
        <div class="tab-section hidden" id="tab-s11">
            <div class="bg-white rounded-lg shadow p-6 mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <x-ossat-yesno name="restrictions_mouvement" label="20.1 Restrictions de mouvement ?" value="{{ $ossat->restrictions_mouvement }}" />
                    <div>
                        ...
                        <select name="tensions_communaute"
                            ...
                            @foreach($choices['yesno_pasdire'] as $opt)
                                <option value="{{ $opt }}" {{ old('tensions_communaute', $ossat->tensions_communaute) == $opt ? 'selected' : '' }}>{{ $opt }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div>
                        ...
                        <select name="incidents_securitaires"
                            ...
                            <option value="">--</option>
                            @foreach($choices['yesno_pasdire'] as $opt)
                                <option value="{{ $opt }}" {{ old('incidents_securitaires', $ossat->incidents_securitaires) == $opt ? 'selected' : '' }}>{{ $opt }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div id="cond_nature_incident">
                        ...
                        <textarea name="nature_incident" rows="2"
                            class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">{{ old('nature_incident', $ossat->nature_incident) }}</textarea>
                    </div>
                    <x-ossat-yesno name="sentiment_securite" label="20.7 Les gens se sentent-ils en sécurité ?" value="{{ $ossat->sentiment_securite }}" />
                    <x-ossat-yesno name="services_handicapes" label="20.11 Services adéquats pour les personnes handicapées ?" value="{{ $ossat->services_handicapes }}" />
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">20.13 Familles sans documents nécessaires</label>
                        <input type="number" name="familles_sans_documents" value="{{ old('familles_sans_documents', $ossat->familles_sans_documents ?? 0) }}" min="0"
                            class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">20.14 Distance tribunaux/état civil (km)</label>
                        <input type="text" name="distance_tribunaux" value="{{ old('distance_tribunaux', $ossat->distance_tribunaux) }}"
                            class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                    </div>
                    <x-ossat-yesno name="acces_tribunaux" label="20.14 Accès aux tribunaux accessible ?" value="{{ $ossat->acces_tribunaux }}" />
                </div>
            </div>
        </div>
        ...
        <div class="tab-section hidden" id="tab-s12">
            <div class="bg-white rounded-lg shadow p-6 mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <x-ossat-yesno name="ecole_primaire_presente" label="21.1 École primaire fonctionnelle à l'intérieur ?" value="{{ $ossat->ecole_primaire_presente }}" />
                    <div id="cond_distance_ecole_primaire">
                        ...
                        <input type="text" name="distance_ecole_primaire" value="{{ old('distance_ecole_primaire', $ossat->distance_ecole_primaire) }}"
                            class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                    </div>
                    <x-ossat-yesno name="ecole_secondaire_presente" label="21.3 École secondaire fonctionnelle à l'intérieur ?" value="{{ $ossat->ecole_secondaire_presente }}" />
                    <div id="cond_distance_ecole_secondaire">
                        ...
                        <input type="text" name="distance_ecole_secondaire" value="{{ old('distance_ecole_secondaire', $ossat->distance_ecole_secondaire) }}"
                            class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">21.5 Enfants en âge scolaire avec accès</label>
                        <input type="number" name="nb_enfants_scolarises" value="{{ old('nb_enfants_scolarises', $ossat->nb_enfants_scolarises ?? 0) }}" min="0"
                            class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                    </div>
                    <x-ossat-yesno name="education_informelle" label="21.7 Éducation informelle disponible ?" value="{{ $ossat->education_informelle }}" />
                    <div id="cond_nb_enfants_education_informelle">
                        ...
                        <input type="number" name="nb_enfants_education_informelle" value="{{ old('nb_enfants_education_informelle', $ossat->nb_enfants_education_informelle ?? 0) }}" min="0"
                            class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <x-ossat-yesno name="marche_interieur" label="22.1 Marché à l'intérieur du site ?" value="{{ $ossat->marche_interieur }}" />
                    <div id="cond_distance_marche">
                        ...
                        <input type="text" name="distance_marche" value="{{ old('distance_marche', $ossat->distance_marche) }}"
                            class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">22.5 Familles ayant un revenu (30 derniers jours)</label>
                        <input type="number" name="nb_familles_avec_revenu" value="{{ old('nb_familles_avec_revenu', $ossat->nb_familles_avec_revenu ?? 0) }}" min="0"
                            class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">22.6 Jeunes (&lt;18 ans) ayant travaillé</label>
                        <input type="number" name="nb_jeunes_travaillant" value="{{ old('nb_jeunes_travaillant', $ossat->nb_jeunes_travaillant ?? 0) }}" min="0"
                            class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                    </div>
                    <x-ossat-yesno name="enclos_betail" label="22.7 Existence d'enclos pour bétail ?" value="{{ $ossat->enclos_betail }}" />
                </div>
                @php $sourcesSubsistance = old('sources_subsistance', (array)($ossat->sources_subsistance ?? [])); @endphp
                <div class="mt-4">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-2">
                        ...
                        <label class="flex items-center gap-2 text-sm">
                            <input type="checkbox" name="sources_subsistance[]" value="{{ $opt }}"
                                {{ in_array($opt, $sourcesSubsistance) ? 'checked' : '' }}
                                class="h-4 w-4 text-blue-600 border-gray-300 rounded">
                            {{ $opt }}
                        </label>
                        @endforeach
        ...
        <div class="tab-section hidden" id="tab-s14">
            <div class="bg-white rounded-lg shadow p-6 mb-6">
                ...
                <div class="grid grid-cols-1 gap-4">
                    ...
                    @php
                        $presenceField = 'partenaires_'.$key.'_presence';
                        $autreField = 'partenaires_'.$key.'_autre';
                        $checked = old($presenceField, $ossat->$presenceField ?? false);
                    @endphp
                    <div class="border rounded-lg p-4">
                        <div class="flex items-center gap-4">
                            <label class="flex items-center gap-2 font-medium text-gray-700 w-64 shrink-0">
                                <input type="checkbox" name="{{ $presenceField }}" value="1"
                                    {{ $checked ? 'checked' : '' }}
                                    class="h-4 w-4 text-blue-600 border-gray-300 rounded">
                                {{ $label }}
                            </label>
                            <input type="text" name="{{ $autreField }}"
                                value="{{ old($autreField, $ossat->$autreField) }}"
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const initialSiteId = {{ $ossat->site_id ?? 'null' }};
    ...
    function loadSites(territoireId, selectedSiteId) {
        ...
        fetch('/api/sites-par-territoire?territoire_id=' + territoireId)
            ...
            .then(function(sites) {
                ...
                const selOpt = siteSelect.options[siteSelect.selectedIndex];
                if (selOpt && selOpt.dataset.nom) {
                    document.getElementById('site_nom_hidden').value = selOpt.dataset.nom;
                    document.getElementById('site_code_hidden').value = selOpt.dataset.code || '';
                }
            });
    }
    ...
    // Pré-charger les sites pour le territoire existant
    if (territoireSelect.value) {
        loadSites(territoireSelect.value, initialSiteId);
    }
