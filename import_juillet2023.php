<?php
/**
 * Script d'import: Master List DRC Aout 2023 -> SiteMouvementPopulation Juillet 2023
 *
 * Correspondance principale: NOM DU SITE (col H) -> Site::nom dans la DB
 * Desambiguisation secondaire: CODE SITE Excel (col I) -> Site::code_site
...
// CONFIG
// ============================================================
$FILE = 'H:\008 - 31082023_Master List DRC_Aout 2023_v3.xlsx';
$DATE = '2023-07-31';
$PERIODE = '2023-07';
$TYPE = 'recensement';
$SOURCE = 'Master List DRC Aout 2023';
...
function findDataSheet(Spreadsheet $spreadsheet): Worksheet
{
    ...
    return $spreadsheet->getSheet(1) ?? $spreadsheet->getSheet(0);
}
...
echo "Feuille utilisee: " . $sheet->getTitle() . PHP_EOL;
